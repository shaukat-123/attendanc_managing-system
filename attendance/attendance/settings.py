...
SECRET_KEY = 'django-insecure-5ci_zyoly$ao%evv#ahagg7y8gt=&xyv&a_xjhw6gc5k@m1a2b'
...
SIMPLE_JWT = {
    ...
    'REFRESH_TOKEN_LIFETIME': timedelta(days=7),   # Assuming you want a longer validity for refresh tokens
}
